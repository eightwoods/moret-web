import{k as w,l as T,t as x,d as S,m as L,s as k,a as P,o as I,p as N,q as u,r as A}from"./main.f9aae886.js";import F from"./component.chartComparison.2145fb22.js";import q from"./component.percentageBarMulti.77012433.js";var H={globals:{elem:document.querySelector(".perpetual")},init(){const e=document.querySelector(".perpetual-list-content .js-refresh");e&&e.addEventListener("click",()=>this.setPerpetuals());const t={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(i=>{console.log("sidenav refreshed from Perpetual!");for(let s of i)if(s.type==="attributes")switch(s.attributeName){case"sidenav-activechange":this.setPerpetuals();break}this.globals.init=!1}).observe(this.globals.elem.querySelector(".sidenav"),t)},setPerpetuals(){alert("setPerpetuals()"),console.log("setPerpetuals()");const e=document.querySelector(".perpetual-list"),t=document.querySelector(".perpetual-info");w(e),w(t);const a=e.querySelector(".comp-dynamic-table");a.innerHTML=`
