import{y as m,B as g,S,A as y,C,m as T,s as x,a as b,D as N,E as A,F as k}from"./main.31f236c8.js";var E={globals:{elem:document.querySelector(".saver")},init(){const t={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(s=>{console.log("sidenav refreshed from Saver!");for(let n of s)if(n.type==="attributes")switch(n.attributeName){}this.globals.init=!1}).observe(this.globals.elem.querySelector(".sidenav"),t)},setSavers(){const t=document.querySelector(".saver-list"),a=document.querySelector(".active-hottubs");m(t),m(a);const s=t.querySelector(".comp-dynamic-table");s.innerHTML=`
            ...
            <div class="swiper-button-prev hide-important"></div>`,g(null).then(r=>{m(t,!1),m(a,!1);const d=[];let l="";const u=Math.floor(Date.now()/1e3);r.forEach(e=>{d.push([e.Name,e.Holding,e.UnitAsset,e.StaticYield,e.ProfitLoss,e.NextVintageTime>u?"Closed":"Open",e.NextVintageStart]);let i=e.NextVintageTime>u?"hidden":"";l+=`
