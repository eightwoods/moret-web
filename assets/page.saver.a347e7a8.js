import{y as v,B as g,S as x,A as y,C,m as T,s as b,a as S,D as A,E as N,F as k}from"./main.2d28c5b2.js";var E={globals:{elem:document.querySelector(".saver")},init(){document.querySelector(".pools .js-refresh").addEventListener("click",()=>this.setSavers());const t={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(s=>{console.log("sidenav refreshed from Saver!");for(let n of s)if(n.type==="attributes")switch(n.attributeName){case"sidenav-activechange":this.setSavers();break}this.globals.init=!1}).observe(this.globals.elem.querySelector(".sidenav"),t)},setSavers(){const t=document.querySelector(".saver-list"),a=document.querySelector(".active-hottubs");v(t),v(a);const s=t.querySelector(".comp-dynamic-table");s.innerHTML=`
            ...
            <div class="swiper-button-prev hide-important"></div>`,g(null).then(r=>{v(t,!1),v(a,!1);const d=[];let l="";const m=Math.floor(Date.now()/1e3);r.forEach(e=>{d.push([e.Name,e.Holding,e.UnitAsset,e.StaticYield,e.ProfitLoss,e.NextVintageTime>m?"Closed":"Open",e.NextVintageStart]),l+=`
