import{k as f,l as w,t as x,d as L,m as S,s as I,a as k,o as P,p as N,q as u,r as A}from"./main.50f9f798.js";import F from"./component.chartComparison.2145fb22.js";import q from"./component.percentageBarMulti.51bb4846.js";var H={globals:{elem:document.querySelector(".perpetual"),btnRefresh:document.querySelector(".perpetual-list-content .js-refresh"),appInit:!0},init(){this.globals.btnRefresh.addEventListener("click",()=>{this.setPerpetuals(),this.globals.btnRefresh.classList.add("hide")}),setTimeout(()=>{this.globals.appInit&&this.setPerpetuals()},2500);const e={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(t=>{console.log("sidenav refreshed from Perpetual!");for(let n of t)if(n.type==="attributes")switch(n.attributeName){case"sidenav-activechange":this.setPerpetuals();break}}).observe(this.globals.elem.querySelector(".sidenav"),e)},setPerpetuals(){this.globals.appInit=!1,console.log("setPerpetuals()");const e=document.querySelector(".perpetual-list"),a=document.querySelector(".perpetual-info");f(e),f(a);const t=e.querySelector(".comp-dynamic-table");t.innerHTML=`
            ...
            </div>`,this.setPerpetualInfo();const n=[];let s=!0,r=0;w().forEach((i,y)=>{const l=async()=>{try{const o=await u(i,"name"),c=await u(i,"symbol"),p=await u(i,"aum"),m=await u(i,"supply"),g=await u(i,"balance"),h=await u(i,"leverage"),b=await u(i,"strike"),v=await u(i,"notional"),d=await u(i,"params"),$=m>0?p/m:1,C=`$${(m>0?p/m*g:0).toFixed(2)}`;if(n.push({Name:o,Symbol:c,Address:i,Description:`${d[2]} ${c}<br>Leverage achieved by buying ${(Number(d[3])/86400).toFixed(0)}-day options`,MarketCap:`$${p.toFixed(0)}`,UnitAsset:$,Holding:C,Leverage:h,SetLevel:d[0],CriticalLevel:d[1],Target:Math.ceil((d[0]+d[1])/2),Direction:d[2],Tenor:d[3],Strike:b,Notional:v}),r++,A.setDynamic(t,[o,d[2],h.toFixed(1)+"x",C,`$${$.toFixed(2)}`],!1,w().length,r),s&&(f(e,!1),f(a,!1),this.setPerpetualInfo(n[0]),s=!1),w().length>1){const T=t.querySelector(`tbody tr:nth-child(${r})`);T.classList.add("cursor"),T.addEventListener("click",()=>{this.setPerpetualInfo(n[T.dataset.id-1])},!1)}w().length===r&&this.globals.btnRefresh.classList.remove("hide"),console.log("Success!!! Row:",r,i)}catch{console.log("Failed!!! Row:",r+1,i);const o=setTimeout(()=>{l(),clearTimeout(o)},2500)}};l()})},setPerpetualInfo(e){const a=document.querySelector(".perpetual-info-content");if(!e){a.textContent="";return}a.innerHTML=`
