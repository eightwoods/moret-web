import{k as f,u as g,t as $,d as C,s as I,a as D,v as k,x as A,y as v,r as E}from"./main.d75df388.js";import F from"./component.chartComparison.2145fb22.js";import q from"./component.percentageBarMulti.cb0a79be.js";var U={globals:{elem:document.querySelector(".saver"),btnRefresh:document.querySelector(".saver-list-content .js-refresh"),appInit:!0},init(){this.globals.btnRefresh.addEventListener("click",()=>this.setSavers()),setTimeout(()=>{this.globals.appInit&&this.setSavers()},2500);const e={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(t=>{console.log("sidenav refreshed from Saver!");for(let i of t)if(i.type==="attributes")switch(i.attributeName){case"sidenav-activechange":this.setSavers();break}}).observe(this.globals.elem.querySelector(".sidenav"),e)},setSavers(){this.globals.appInit=!1,this.globals.btnRefresh.classList.add("hide"),console.log("setSavers()");const e=document.querySelector(".saver-list"),a=document.querySelector(".saver-info");f(e),f(a);const t=e.querySelector(".comp-dynamic-table");t.innerHTML=`
            ...
            <div class="buttons-container"></div>`,e.VintageOpen&&(a.querySelector(".buttons-container").innerHTML=`
                ...
                </div>`),F.createChart({elem:a.querySelector(".chart-comparison"),endpoint1:`https://api.binance.com/api/v3/klines?symbol=${$()}${C()}T&interval=12h&limit=${Math.ceil(e.Tenor/3600)}`,endpoint2:`https://api.binance.com/api/v3/klines?symbol=TKOUSDT&interval=12h&limit=${Math.ceil(e.Tenor/3600)}`,linedata:[e.StartLevel,e.Upside,e.Downside,e.Downside-e.Protection]}),q.progressBar(a.querySelector(".percentage-bar-multi"),e.ProfitLoss/e.Yield*100,100),e.VintageOpen&&(a.querySelector(".js-save").addEventListener("click",t=>{t.preventDefault(),this.setPopupInfo({type:"save",title:"Top up to vault",data:e,amount:parseFloat(document.querySelector("input[name='usdc-amount']").value)})},!1),a.querySelector(".js-withdraw").addEventListener("click",t=>{t.preventDefault(),this.setPopupInfo({type:"withdraw",title:"Withdraw from vault",data:e,amount:parseFloat(document.querySelector("input[name='usdc-amount']").value)})},!1))},setPopupInfo(e){console.log(e);let a=e.data.UnitAsset==0?e.amount:e.amount/e.data.UnitAsset;const t=[{name:"Name:",span:e.data.Name},{name:"Address:",span:e.data.Address},{name:"Unit price",span:`$${e.data.UnitAsset}`},{name:"Units:",span:`${a.toFixed(2)} ${e.data.Symbol}`},{name:"Trade value:",span:`$${e.amount.toFixed(2)}`}];I(e.title,D(t,"investinsavers")),this.executeTrade(e.type,e.data.Address,e.amount,a)},executeTrade(e,a,t,i){const n=document.createElement("div");n.className="executetrade",document.querySelector(".overlay-popup .op-content").appendChild(n);let o="blue";e==="save"?o="green":e==="withdraw"&&(o="pink");const s=document.createElement("a");s.setAttribute("href","#"),s.className=`btn btn-${o}`,s.textContent="Execute",n.appendChild(s),s.addEventListener("click",async T=>{T.preventDefault(),s.remove();const p=document.createElement("div");p.className="await-approval",p.textContent="Awaiting for allowance approval";const l=document.createElement("div");l.className="await-approval-timer",l.textContent="00:00",p.appendChild(l),n.appendChild(p);const u=document.createElement("div");u.className="await-trade",u.textContent="Awaiting for transaction";const c=document.createElement("div");c.className="await-trade-timer",c.textContent="00:00",u.appendChild(c),n.appendChild(u),this.executeTradeTimer(l,120);const h="Warning: Transaction has failed.",b=await k(e,a,t,i);console.log("approve finished",b),b==="failure"?this.executeTradeFailure(n,h):(p.classList.add("await-active"),p.textContent="Allowance approved.",l.remove(),this.clearTradeTimer(),setTimeout(async()=>{this.executeTradeTimer(c,e==="propose"?300:120),console.log("prior to trade",e,a,t,i);const r=await A(e,a,t,i);if(console.log("trade finished",r),r==="")this.executeTradeFailure(n,h);else{u.classList.add("await-active"),u.textContent="Transaction mined.",c.remove(),this.clearTradeTimer();const d=document.createElement("div");d.className="approve-trade-link";const m=document.createElement("a");m.setAttribute("href",r),m.setAttribute("target","_blank"),m.className="link-arrow",m.textContent="View on Polygonscan",d.appendChild(m),n.appendChild(d)}},500))},!1)},executeTradeFailure(e,a){const t=document.createElement("div");t.className="await-failure";const i=document.createElement("div");i.className="warning-icon";const n=document.createElement("div");n.className="warning-text",n.textContent=a,t.appendChild(i),t.appendChild(n),e.appendChild(t)},executeTradeTimer(e,a){const t=n=>n>9?n:`0${n}`;let i=0;this.globals.execIntervalId=setInterval(()=>{i++,i>a?(this.executeTradeFailure(document.querySelector(".overlay-popup .executetrade"),"Warning: Transaction has taking longer than normal to be mined. You can close the window and try to trade again."),this.clearTradeTimer()):e.textContent=`${t(parseInt(i/60))}:${t(i%60)}`},1e3)},clearTradeTimer(){clearInterval(this.globals.execIntervalId),this.globals.execIntervalId=null,console.log("clearTradeTimer()")}};export{U as default};
