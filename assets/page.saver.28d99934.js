import{y as m,B as b,S as x,A as y,C as g,m as w,s as T,a as S,D as A,E as C,F as N}from"./main.41f8fcd9.js";var q={globals:{elem:document.querySelector(".saver")},init(){document.querySelector(".pools .js-refresh").addEventListener("click",()=>this.setSavers());const e={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(s=>{console.log("sidenav refreshed from Saver!");for(let a of s)if(a.type==="attributes")switch(a.attributeName){case"sidenav-activechange":this.setSavers();break}this.globals.init=!1}).observe(this.globals.elem.querySelector(".sidenav"),e)},setSavers(){const e=document.querySelector(".saver-list"),r=document.querySelector(".active-hottubs");m(e),m(r);const s=e.querySelector(".comp-dynamic-table");s.innerHTML=`
            ...
            <div class="swiper-button-prev hide-important"></div>`,b(null).then(n=>{m(e,!1),m(r,!1);const o=[];let u="";const c=Math.floor(Date.now()/1e3);n.forEach(t=>{o.push([t.Name,t.UnitHeld,t.UnitAsset,t.StaticYield,t.ProfitLoss,t.NextVintageTime>c?"Closed":"Open",t.NextVintage]),u+=`
                    <div class="swiper-slide">
                        <div class="in-box">
                            <ul class="info">
                                <li class="info-name">Name: <span>${t.Name}</span></li>
                                <li class="info-name">Symbol: <span>${t.Symbol}</span></li>
                                <li class="info-address">Address: <span>${t.Address}</span></li>
                                <li>Market Cap: <span>${t.MarketCap}</span></li>
                                <li>Vintage Start Price: <span>${t.StartLevel}</span></li>
                                <li>Upside Potential: <span>${t.Upside}</span></li>
                                <li>Protection Starts: <span>${t.Downside}</span></li>
                                <li>Protection Depth: <span>${t.Protection}</span></li>
                            </ul>
