import{k as w,l as T,t as x,d as S,m as L,s as I,a as k,o as P,p as N,q as u,r as A}from"./main.1d093a19.js";import F from"./component.chartComparison.2145fb22.js";import q from"./component.percentageBarMulti.7f778c12.js";var H={globals:{elem:document.querySelector(".perpetual"),appInit:!0},init(){const e=document.querySelector(".perpetual-list-content .js-refresh");e&&e.addEventListener("click",()=>this.setPerpetuals()),setTimeout(()=>{this.globals.appInit&&this.setPerpetuals()},2500);const t={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(i=>{console.log("sidenav refreshed from Perpetual!");for(let s of i)if(s.type==="attributes")switch(s.attributeName){case"sidenav-activechange":this.setPerpetuals();break}}).observe(this.globals.elem.querySelector(".sidenav"),t)},setPerpetuals(){this.globals.appInit=!1,console.log("setPerpetuals()");const e=document.querySelector(".perpetual-list"),t=document.querySelector(".perpetual-info");w(e),w(t);const a=e.querySelector(".comp-dynamic-table");a.innerHTML=`
            ...
            </div>`,this.setPerpetualInfo();const i=[];let s=!0,o=0;T().forEach((n,y)=>{const l=async()=>{try{const r=await u(n,"name"),c=await u(n,"symbol"),p=await u(n,"aum"),m=await u(n,"supply"),g=await u(n,"balance"),h=await u(n,"leverage"),b=await u(n,"strike"),v=await u(n,"notional"),d=await u(n,"params"),$=m>0?p/m:1,C=`$${(m>0?p/m*g:0).toFixed(2)}`;if(i.push({Name:r,Symbol:c,Address:n,Description:`${d[2]} ${c}<br>Leverage achieved by buying ${(Number(d[3])/86400).toFixed(0)}-day options`,MarketCap:`$${p.toFixed(0)}`,UnitAsset:$,Holding:C,Leverage:h,SetLevel:d[0],CriticalLevel:d[1],Target:Math.ceil((d[0]+d[1])/2),Direction:d[2],Tenor:d[3],Strike:b,Notional:v}),o++,A.setDynamic(a,[r,d[2],h.toFixed(1)+"x",C,`$${$.toFixed(2)}`],!1,T().length,o),s&&(w(e,!1),w(t,!1),this.setPerpetualInfo(i[0]),s=!1),T().length>1){const f=a.querySelector(`tbody tr:nth-child(${o})`);f.classList.add("cursor"),f.addEventListener("click",()=>{this.setPerpetualInfo(i[f.dataset.id-1])},!1)}console.log("Success!!! Row:",o,n)}catch{console.log("Failed!!! Row:",o+1,n);const r=setTimeout(()=>{l(),clearTimeout(r)},2500)}};l()})},setPerpetualInfo(e){const t=document.querySelector(".perpetual-info-content");if(!e){t.textContent="";return}t.innerHTML=`
