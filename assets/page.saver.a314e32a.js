import{y as u,B as x,S as g,A as y,C,m as T,s as S,a as b,D as A,E as N,F as k}from"./main.4213a5e7.js";var E={globals:{elem:document.querySelector(".saver")},init(){document.querySelector(".pools .js-refresh").addEventListener("click",()=>this.setSavers());const t={childList:!0,attributes:!0,attributeFilter:["sidenav-activechange","sidenav-refreshprice"]};new MutationObserver(s=>{console.log("sidenav refreshed from Saver!");for(let n of s)if(n.type==="attributes")switch(n.attributeName){case"sidenav-activechange":this.setSavers();break}this.globals.init=!1}).observe(this.globals.elem.querySelector(".sidenav"),t)},setSavers(){const t=document.querySelector(".saver-list"),a=document.querySelector(".active-hottubs");u(t),u(a);const s=t.querySelector(".comp-dynamic-table");s.innerHTML=`
            ...
            <div class="swiper-button-prev hide-important"></div>`,x(null).then(r=>{u(t,!1),u(a,!1);const d=[];let l="";const m=Math.floor(Date.now()/1e3);r.forEach(e=>{d.push([e.Name,e.UnitHeld,e.UnitAsset,e.StaticYield,e.ProfitLoss,e.NextVintageTime>m?"Closed":"Open",e.NextVintage]),l+=`
                    <div class="swiper-slide">
                        <div class="in-box">
                            <ul class="info">
                                ...
                                <li>Next Vintage Starts: <span>${e.NextVintageStart}</span></li>
                            </ul>
