...
export const getPrice = async (tokenAddress) => {
    const moretContract = await getContract(web3, '/src/json/Moret.json', "0x8f529633a6736E348a4F97E8E050C3EEd78C3C0a")
    const oracleAddress = await moretContract.methods.getVolatilityChain(String(tokenAddress)).call()
    const oracle = await getContract(web3, '/src/json/VolatilityChain.json', oracleAddress)
